# Advanced Angular Training - Resources 

## Glencore & Kevin Cunningham - Feb 2023
 
The following list contain a selection of resources in support of the advanced Angular training course. This is not a definitive collection and will certainly be superseded as Angular evolves, but these resources reflect the current scope of informed opinion in key areas of Angular

I've drawn a lot from this list which might be more up-to-date but these are the bits I've found most interesting/helpful.
...
# Free APIs providing placeholder content
Here is a small selection of APIs which can be used to provide sample content

## Placeholder Image Resources
http://placehold.it/250x320/ff9933?text=some+text
https://dummyimage.com/256x256/000/fff.jpg
https://via.placeholder.com/240x120/FF0000/FFFFFF?text=wxh-bg-fg
http://picsum.photos/10/10
http://lorempixel.com
...
https://swapi.co/api/
https://openweathermap.org/api (requires free API key)
